...
int main (int argc, char *argv[])
{
  ...
  { 
      ...
      if( msg == "exista" )   // exista deja aplicatia, intreb daca vrea sa introduca alta versiune
      {
        ...
        if( msg == "da" )
        {
          do{
            ...
            if( nume_fisier != "nu" )
            {
              cod = send_file_to_server( sd , nume_fisier );
              if ( cod == 1 )
              {
              ...
              {
                cout << "[client]Fisierul introdus nu exista!\n";
                fflush(stdout);
              }
              else
              {
    ...
    else if( funct == 2 )   // cautare
    {
      ...
      if( alegere != "nu" )
      {
        cod = receive_file_from_server( sd );
        if( cod == 1 )
        {
        ...
        {
          cout << "[client]Fisierul id_kit introdus nu exista!\n";
          fflush(stdout);
        }
        else
        {
